...
const docs = [
  {
    ...
    href: "/fizzog/legal/privacy-policy",
    icon: ShieldCheck,
    color: "bg-blue-600/20 text-blue-400",
  },
  {
    label: "Terms of Usage",
    desc: "Terms & Conditions governing use of Fizzog®",
    href: "/fizzog/legal/terms",
    icon: FileText,
    color: "bg-[#f5a623]/20 text-[#f5a623]",
  },
  {
    label: "Data Safety & Transparency",
    desc: "Your rights under POPIA and how we handle your information",
    href: "/fizzog/legal/data-safety",
    icon: Database,
    color: "bg-emerald-600/20 text-emerald-400",
  },
];

export default function FizzogLegalPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="mt-8 mb-10">
        ...
        <p className="text-white/50">
          Fizzog® is owned and operated by Ten Bucks (Pty) Ltd, registered in the Republic of South Africa.
        </p>
      </div>
